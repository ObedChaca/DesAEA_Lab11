    ...
    public class OfficeAssignmentsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(officeAssignments
                .Where(x => x.Instructor.HireDate != null && x.Enable == true)
                .ToList());
        }
        ...
        {
            //Get Only Instructors
            ViewBag.InstructorID = new SelectList(db.Instructors.Where(x => x.HireDate != null), "ID", "LastName");
